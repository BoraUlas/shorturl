...
function ShortUrl() {
  ...
  const ShortLink = (e) => {
    axios
      .post("https://ulasbora-shortlnk-api.onrender.com/url/add", {
        OrginalUrl: url,
  ...
  const DeleteLink = (id) => {
    axios
      .delete("https://ulasbora-shortlnk-api.onrender.com/url/delete/"+id, {
  ...
  useEffect(() => {
    axios
      .get(
        "https://ulasbora-shortlnk-api.onrender.com/url/getbycreatedby/" +
          username
      )
      .then(function (response) {
